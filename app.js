    ...
    return {
      displayDate: function() {
        ...
        document.querySelector(DOMstrings.dateLabel).textContent =
          unuudur.getFullYear() + " оны " + (unuudur.getMonth() + 1) + " сарын " + unuudur.getDate() + " ны";
      },
      ...
      getInput: function() {
        var time = new Date();
        var odoo = time.getFullYear() + ' оны ' + (time.getMonth() + 1)+ ' Сарын ' + time.getDate() + ' ны ' + time.getHours() + ' Цаг ' + time.getMinutes() + 'минут';
        return {
      ...
      addListItem: function(item, type) {
        ...
        if (type === "inc") {
          ...
          html =
            '<div class="item clearfix" id="inc-%id%"><div class="item__description">$$DESCRIPTION$$ <p>%date%</p></div><div class="right clearfix"><div class="item__value">$$VALUE$$</div><div class="item__delete">            <button class="item__delete--btn"><i class="ion-ios-close-outline"></i></button></div>        </div></div>';
        } else {
          list = DOMstrings.expenseList;
          html =
            '<div class="item clearfix" id="exp-%id%"><div class="item__description">$$DESCRIPTION$$ <p>%date%</p></div>          <div class="right clearfix"><div class="item__value">$$VALUE$$</div><div class="item__percentage">21%</div><div class="item__delete"><button class="item__delete--btn">                <i class="ion-ios-close-outline"></i></button></div></div></div>';
        }
  ...
  var financeController = (function() {
    ...
    return {
      ...
      addItem: function(type, desc, val, date) {
        ...
        if (type === "inc") {
          item = new Income(id, desc, val, date);
        } else {
          item = new Expense(id, desc, val, date);
        }
